        ...
        <div className="my-projects-container my-projects-container-malignants">
            ...
            <div className="my-projects-container-right">
                ...
                <div className="my-projects-container-right-buttons">
                    <a href="https://mattigor.github.io/website_alimentacao/" rel="noopener noreferrer" target="_blank"><button className="my-projects-container-right-buttons-button my-projects-container-right-buttons-button-left">Visitar o projeto
